...
const DEFAULT_HAMPER_ITEMS: HamperItem[] = [
  {
    id: 'lao-gan-ma-crispy-chili-oil',
    name: 'Lao Gan Ma Crispy Chili Oil',
    weight: '210g Jar',
    price: 3.85,
    image: 'https://images.unsplash.com/photo-1588644525273-f37b60d78512?auto=format&fit=crop&w=300&q=80',
    quantity: 1,
  },
  {
    id: 'samyang-buldak-2x-spicy-ramen',
    name: 'Samyang 2x Spicy Buldak Ramen',
    weight: '140g 5-Pack',
    price: 6.95,
  ...
  {
    id: 'lee-kum-kee-premium-dark-soy-sauce',
    name: 'Lee Kum Kee Premium Dark Soy Sauce',
    weight: '500ml Bottle',
    price: 2.95,
    image: 'https://images.unsplash.com/photo-1607672632458-9eb56696346b?auto=format&fit=crop&w=300&q=80',
    quantity: 1,
  },
  {
    id: 'royal-umbrella-thai-jasmine-fragrant-rice',
  ...
  {
    id: 'aroy-d-100-pure-coconut-milk',
    name: 'Aroy-D 100% Pure Coconut Milk',
    weight: '400ml Can',
    price: 2.49,
  ...
  {
    id: 'handmade-pork-chive-gyoza-dumplings',
    name: 'Handcrafted Pork & Chive Gyoza',
    weight: '600g (30 pcs)',
    price: 6.99,
