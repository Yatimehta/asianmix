...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Crispy banana chips, spicy mixture, Haldirams favorites, Soan Papdi, and authentic South Indian crunch.',
  ...
  },
  {
    ...
    subtitle: 'Shipped in temperature-controlled packaging so your fresh gourds, okra, green chillies, and roots arrive kitchen-fresh.',
