...
const ARTICLES = [
  {
    id: 1,
    category: 'Quick Weeknight Meal',
    readTime: '4 min read',
    title: 'Mastering 10-Minute Spicy Chili Crisp Noodles at Home',
    excerpt: 'Turn plain noodles into street-food perfection with Lao Gan Ma crispy chili oil, dark soy, minced garlic, and fresh scallions.',
    image: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=600&q=80',
    link: '/products?category=rice-noodles',
  },
  {
    id: 2,
    category: 'Dim Sum Secrets',
    readTime: '6 min read',
    title: 'The Secret to Golden, Crispy Pan-Fried Gyoza Dumplings',
    excerpt: 'Learn the authentic starch-water slurry technique for paper-thin lace skirts, paired with traditional Chinkiang black vinegar dip.',
    image: 'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?auto=format&fit=crop&w=600&q=80',
    link: '/products?category=frozen-fresh',
  },
  {
    id: 3,
    category: 'Pantry Essentials',
    readTime: '5 min read',
    title: '5 Must-Have Asian Pantry Sauces Every Irish Kitchen Needs',
    excerpt: 'From umami-dense oyster sauce to sun-ripened Sriracha and natural fish sauce — essential bottles that elevate everyday dinners.',
    image: 'https://images.unsplash.com/photo-1588644525273-f37b60d78512?auto=format&fit=crop&w=600&q=80',
