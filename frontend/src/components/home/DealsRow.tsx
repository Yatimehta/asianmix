...
const DEALS = [
  {
    ...
    badgeIcon: Flame,
    title: 'Spicy Ramen & Noodle Bundles',
    subtitle: 'Save up to 30% on viral Buldak, Nongshim Shin & authentic Japanese Soba.',
    cta: 'Claim Daily Deal',
    href: '/products?category=rice-noodles',
  ...
  },
  {
    ...
    badgeIcon: Sparkles,
    title: 'Farm-Fresh Asian Greens & Tofu',
    subtitle: 'Crisp pak choi, enoki mushrooms, gyoza dumplings with eco ice packaging.',
    cta: 'Shop Fresh Deals',
    href: '/products?category=frozen-fresh',
  ...
  },
  {
    ...
    badgeIcon: Tag,
    title: 'Chili Oils, Soy & Wok Sauces',
    subtitle: 'Buy 1 Get 1 on selected Lao Gan Ma, premium dark soy and artisan condiments.',
    cta: 'Unlock BOGO Offer',
    href: '/products?category=pickles-and-paste',
    accentBg: 'bg-gradient-to-br from-[#D97706] to-[#78350F]',
    image: 'https://images.unsplash.com/photo-1588644525273-f37b60d78512?auto=format&fit=crop&w=500&q=80',
